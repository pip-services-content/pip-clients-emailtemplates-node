# Development and Testing Guide <br/> EmailTemplates Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-content/pip-clients-emailtemplates-node.git
```
